...
SUT_PARAMETERS="machbase=machbase.host=$DB_HOST,machbase.port=$DB_PORT,machbase.batchsize=$DB_BATCHSIZE"

COORDINATOR_HOME="/media/disk1/interp/nodes/coordinator1/"
